...
enum HtmlTreeBuilderState {
                ...
                case EndTag:
                    ...
                    if (StringUtil.inSorted(name, Constants.InBodyEndAdoptionFormatters)) {
                        ...
                        for (int i = 0; i < 8; i++) {
                            ...
                            // run-aways
                            Element commonAncestor = getCommonAncestor(tb, formatEl);
                            Element furthestBlock = getFurthestBlock(tb, formatEl);
    ...
    private static Element getCommonAncestor(HtmlTreeBuilder tb, Element formatEl) {
        ArrayList<Element> stack = tb.getStack();
    ...
    private static Element getFurthestBlock(HtmlTreeBuilder tb, Element formatEl) {
        ArrayList<Element> stack = tb.getStack();
        final int stackSize = stack.size();
